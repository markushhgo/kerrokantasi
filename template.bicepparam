...
param openIdClientId = 'client-id-configured-to-your-opendid-provider'
param openIdAudience = 'https://auth-url.domain/path'
param openIdAuthority = 'your-authority'
param openIdApiTokenUrl = 'https://auth-url.domain/api-tokens/'
